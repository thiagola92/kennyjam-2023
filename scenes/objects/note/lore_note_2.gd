...
func _ready() -> void:
	_messages = [
		...
		["But in the meanwhile we figured somethings out, since the only thing left to do, apart from crying", 3],
		["Apperently this is not the reality we know (as expected), but actually a place like a cell for something much darker", 9],
		["The thing outsite, the one who travels in the eternal dark of this place, is an old entity", 7],
		["Something that some cientists awoke when studying about it and were scared enough to create this place afterwards", 9],
		...
		["If, for some reason, you start seeing things... Be careful, that thing is near\"", 5],
		["...", 2],
	]
